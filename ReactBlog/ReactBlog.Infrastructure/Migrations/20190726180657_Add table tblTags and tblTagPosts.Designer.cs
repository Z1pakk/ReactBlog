...
namespace ReactBlog.Infrastructure.Migrations
{
    ...
    [Migration("20190726180657_Add table tblTags and tblTagPosts")]
    partial class AddtabletblTagsandtblTagPosts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReactBlog.Core.Entities.Author", b =>
                {
                    b.Property<string>("UserId");
            ...
            modelBuilder.Entity("ReactBlog.Core.Entities.Author", b =>
                {
                    b.HasOne("ReactBlog.Core.Identity.ApplicationUser", "ApplicationUserOf")
                        .WithOne("AuthorOf")
                        .HasForeignKey("ReactBlog.Core.Entities.Author", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ReactBlog.Core.Entities.PostAuthor", b =>
                {
                    b.HasOne("ReactBlog.Core.Entities.Author", "AuthorOf")
